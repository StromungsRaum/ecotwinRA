...
│  │  │                 │  │  ┌─────────────────────────┐│    │   │
│  │  │ - Dashboard     │  │  │  ModelsComponent        ││    │   │
│  │  │ - Settings      │  │  │                         ││    │   │
│  │  │ - Models  ◄────-┼──┼──│  Receives context:      ││    │   │
│  │  │   (your MFE)    │  │  │  - auth token           ││    │   │
│  │  │                 │  │  │  - API URLs             ││    │   │
│  │  └─────────────────┘  │  │  - account info         ││    │   │
│  │                       │  └─────────────────────────┘│    │   │
...
mutation CreateModel($name: String!, $namespace: String!) {
  ianus_platform_mesh_io {
    v1alpha1 {
      createModel(namespace: $namespace, object: { metadata: { name: $name } }) {
        metadata { name }
      }
    }
  }
...
│   │   └── models/
│   │       ├── models.component.ts    # Main UI component
│   │       ├── models.component.html  # Template with UI5 components
│   │       ├── models.component.scss  # Styles
│   │       └── models.service.ts      # GraphQL API service
...
3. **Create a ContentConfiguration** resource pointing to your hosted URL:
   ...
   metadata:
     labels:
       ui.platform-mesh.io/content-for: ianus.platform-mesh.io
     name: models-ui
   spec:
     inlineConfiguration:
       contentType: json
